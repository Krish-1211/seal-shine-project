...
export const Footer = () => {
    return (
        <footer className="bg-primary/5 pt-16 pb-8 border-t border-border w-full overflow-hidden relative">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 lg:gap-10 mb-12">
                    ...
                    <div className="lg:pl-2">
                        ...
                        <ul className="space-y-3">
                            ...
                            <li className="flex items-center gap-3 text-muted-foreground break-words">
                                <Mail className="h-4 w-4 flex-shrink-0" />
                                <span className="break-all">sales@suresealsealants.com.au</span>
                            </li>
                        </ul>
                    </div>
                    ...
                    <div>
                        ...
                        <p className="text-muted-foreground mb-4">
                            Sign up to stay updated with Sure Seal
                        </p>
                        <div className="flex gap-2 min-w-0 flex-wrap">
                            <input
                                type="email"
                                placeholder="Enter your email"
                                className="flex-1 px-4 py-2 rounded-md border border-input bg-background min-w-[200px]"
                            />
